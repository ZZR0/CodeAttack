...
from codeattack.shared import GensimWordEmbedding, WordEmbedding
...
def test_embedding_gensim():
    ...
    from codeattack.shared.utils import LazyLoader
    from codeattack.shared.utils.install import TEXTATTACK_CACHE_DIR
