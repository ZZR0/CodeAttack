...
class SentenceEncoder(Constraint, ABC):
    ...
    def _sim_score(self, starting_text, transformed_text):
        ...
        Args:
            starting_text: The ``AttackedCode``to use as a starting point.
            transformed_text: A transformed ``AttackedCode``
    ...
    def _score_list(self, starting_text, transformed_texts):
        ...
        Args:
            starting_text: The ``AttackedCode``to use as a starting point.
            transformed_texts: A list of transformed ``AttackedCode``
