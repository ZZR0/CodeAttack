...
from codeattack.search_methods import PopulationBasedSearch, PopulationMember
from codeattack.shared.validators import transformation_consists_of_word_swaps
...
class GeneticAlgorithm(PopulationBasedSearch, ABC):
    ...
    def _crossover_operation(self, pop_member1, pop_member2):
        ...
        Returns:
            Tuple of `AttackedCode` and a dictionary of attributes.
        """
        raise NotImplementedError()
    ...
    def _post_crossover_check(
        ...
        Args:
            new_text (AttackedCode): Text produced by crossover operation
            parent_text1 (AttackedCode): Parent text of `new_text`
            parent_text2 (AttackedCode): Second parent text of `new_text`
            original_text (AttackedCode): Original text
        Returns:
