...
from codeattack.attack_results import FailedAttackResult, SkippedAttackResult
from codeattack.metrics import Metric
import codeattack.shared.utils
...
class Perplexity(Metric):
    def __init__(self, model_name="gpt2"):
        ...
        if model_name == "gpt2":
            ...
            self.ppl_model.to(codeattack.shared.utils.device)
        ...
        with torch.no_grad():
            ...
            for i in range(0, input_ids.size(1), self.stride):
                ...
                input_ids_t = input_ids[:, begin_loc:end_loc].to(
                    codeattack.shared.utils.device
                )
