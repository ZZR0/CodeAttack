...
import codeattack
from codeattack.models.helpers import GloveEmbeddingLayer
from codeattack.models.helpers.utils import load_cached_state_dict
...
class WordCNNForClassification(nn.Module):
    ...
    def __init__(
        ...
        self.tokenizer = codeattack.models.tokenizers.GloveTokenizer(
