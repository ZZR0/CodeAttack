...
import codeattack
from codeattack.augment_args import AUGMENTATION_RECIPE_NAMES
...
class AugmentCommand(TextAttackCommand):
    ...
    def run(self, args):
        ...
        args = codeattack.AugmenterArgs(**vars(args))
        if args.interactive:
    ...
    def register_subcommand(main_parser: ArgumentParser):
        ...
        parser = codeattack.AugmenterArgs._add_parser_args(parser)
