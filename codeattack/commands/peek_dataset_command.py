...
logger = codeattack.shared.logger
...
class PeekDatasetCommand(TextAttackCommand):
    ...
    def run(self, args):
        ...
        dataset_args = codeattack.DatasetArgs(**vars(args))
        dataset = codeattack.DatasetArgs._create_dataset_from_args(dataset_args)
        ...
        for inputs, output in dataset:
            at = codeattack.shared.AttackedCode(inputs)
    ...
    def register_subcommand(main_parser: ArgumentParser):
        ...
        parser = codeattack.DatasetArgs._add_parser_args(parser)
