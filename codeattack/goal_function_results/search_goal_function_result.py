...
SearchGoalFunctionResult Class
========================================
...
class SearchGoalFunctionResult(GoalFunctionResult):
    ...
    def _processed_output(self):
        ...
        if self.attacked_text.attack_attrs.get("label_names"):
            ...
            output = codeattack.shared.utils.process_label_name(output)
            color = codeattack.shared.utils.color_from_output(output, output_label)
            return output, color
        else:
            color = codeattack.shared.utils.color_from_label(output_label)
