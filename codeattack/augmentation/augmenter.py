...
from codeattack.constraints import PreTransformationConstraint
...
class Augmenter:
    ...
    def _filter_transformations(self, transformed_texts, current_text, original_text):
        """Filters a list of ``AttackedCode`` objects to include only the ones
    ...
    def augment(self, text):
        ...
        ``self.transformation``."""
        attacked_text = AttackedCode(text)
