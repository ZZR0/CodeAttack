...
class SwapAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from codeattack.transformations import WordInnerSwapRandom
...
class SynonymInsertionAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from codeattack.transformations import WordInsertionRandomSynonym
...
class DeletionAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from codeattack.transformations import WordDeletion
