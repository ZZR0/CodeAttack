...
ATTACK_RECIPE_NAMES = {
    "alzantot": "codeattack.attack_recipes.GeneticAlgorithmAlzantot2018",
    "bae": "codeattack.attack_recipes.BAEGarg2019",
    "bert-attack": "codeattack.attack_recipes.BERTAttackLi2020",
    "faster-alzantot": "codeattack.attack_recipes.FasterGeneticAlgorithmJia2019",
    "deepwordbug": "codeattack.attack_recipes.DeepWordBugGao2018",
    "hotflip": "codeattack.attack_recipes.HotFlipEbrahimi2017",
    "input-reduction": "codeattack.attack_recipes.InputReductionFeng2018",
    "kuleshov": "codeattack.attack_recipes.Kuleshov2017",
    "morpheus": "codeattack.attack_recipes.MorpheusTan2020",
    "seq2sick": "codeattack.attack_recipes.Seq2SickCheng2018BlackBox",
    "textbugger": "codeattack.attack_recipes.TextBuggerLi2018",
    "textfooler": "codeattack.attack_recipes.TextFoolerJin2019",
    "pwws": "codeattack.attack_recipes.PWWSRen2019",
    "iga": "codeattack.attack_recipes.IGAWang2019",
    "pruthi": "codeattack.attack_recipes.Pruthi2019",
    "pso": "codeattack.attack_recipes.PSOZang2020",
    "checklist": "codeattack.attack_recipes.CheckList2020",
    "clare": "codeattack.attack_recipes.CLARE2020",
    "a2t": "codeattack.attack_recipes.A2TYoo2021",
}


BLACK_BOX_TRANSFORMATION_CLASS_NAMES = {
    "random-synonym-insertion": "codeattack.transformations.RandomSynonymInsertion",
    "word-deletion": "codeattack.transformations.WordDeletion",
    "word-swap-embedding": "codeattack.transformations.WordSwapEmbedding",
    "word-swap-homoglyph": "codeattack.transformations.WordSwapHomoglyphSwap",
    "word-swap-inflections": "codeattack.transformations.WordSwapInflections",
    "word-swap-neighboring-char-swap": "codeattack.transformations.WordSwapNeighboringCharacterSwap",
    "word-swap-random-char-deletion": "codeattack.transformations.WordSwapRandomCharacterDeletion",
    "word-swap-random-char-insertion": "codeattack.transformations.WordSwapRandomCharacterInsertion",
    "word-swap-random-char-substitution": "codeattack.transformations.WordSwapRandomCharacterSubstitution",
    "word-swap-wordnet": "codeattack.transformations.WordSwapWordNet",
    "word-swap-masked-lm": "codeattack.transformations.WordSwapMaskedLM",
    "word-swap-hownet": "codeattack.transformations.WordSwapHowNet",
    "word-swap-qwerty": "codeattack.transformations.WordSwapQWERTY",
}


WHITE_BOX_TRANSFORMATION_CLASS_NAMES = {
    "word-swap-gradient": "codeattack.transformations.WordSwapGradientBased"
}
...
CONSTRAINT_CLASS_NAMES = {
    ...
    #
    "embedding": "codeattack.constraints.semantics.WordEmbeddingDistance",
    "bert": "codeattack.constraints.semantics.sentence_encoders.BERT",
    "infer-sent": "codeattack.constraints.semantics.sentence_encoders.InferSent",
    "thought-vector": "codeattack.constraints.semantics.sentence_encoders.ThoughtVector",
    "use": "codeattack.constraints.semantics.sentence_encoders.UniversalSentenceEncoder",
    "muse": "codeattack.constraints.semantics.sentence_encoders.MultilingualUniversalSentenceEncoder",
    "bert-score": "codeattack.constraints.semantics.BERTScore",
    #
    # Grammaticality constraints
    #
    "lang-tool": "codeattack.constraints.grammaticality.LanguageTool",
    "part-of-speech": "codeattack.constraints.grammaticality.PartOfSpeech",
    "goog-lm": "codeattack.constraints.grammaticality.language_models.GoogleLanguageModel",
    "gpt2": "codeattack.constraints.grammaticality.language_models.GPT2",
    "learning-to-write": "codeattack.constraints.grammaticality.language_models.LearningToWriteLanguageModel",
    "cola": "codeattack.constraints.grammaticality.COLA",
    #
    # Overlap constraints
    #
    "bleu": "codeattack.constraints.overlap.BLEU",
    "chrf": "codeattack.constraints.overlap.chrF",
    "edit-distance": "codeattack.constraints.overlap.LevenshteinEditDistance",
    "meteor": "codeattack.constraints.overlap.METEOR",
    "max-words-perturbed": "codeattack.constraints.overlap.MaxWordsPerturbed",
    #
    # Pre-transformation constraints
    #
    "repeat": "codeattack.constraints.pre_transformation.RepeatModification",
    "stopword": "codeattack.constraints.pre_transformation.StopwordModification",
    "max-word-index": "codeattack.constraints.pre_transformation.MaxWordIndexModification",
}


SEARCH_METHOD_CLASS_NAMES = {
    "beam-search": "codeattack.search_methods.BeamSearch",
    "greedy": "codeattack.search_methods.GreedySearch",
    "ga-word": "codeattack.search_methods.GeneticAlgorithm",
    "greedy-word-wir": "codeattack.search_methods.GreedyWordSwapWIR",
    "pso": "codeattack.search_methods.ParticleSwarmOptimization",
}
...
GOAL_FUNCTION_CLASS_NAMES = {
    ...
    #
    "targeted-classification": "codeattack.goal_functions.classification.TargetedClassification",
    "untargeted-classification": "codeattack.goal_functions.classification.UntargetedClassification",
    "input-reduction": "codeattack.goal_functions.classification.InputReduction",
    #
    # Text goal functions
    #
    "minimize-bleu": "codeattack.goal_functions.text.MinimizeBleu",
    "non-overlapping-output": "codeattack.goal_functions.text.NonOverlappingOutput",
    "text-to-text": "codeattack.goal_functions.text.TextToTextGoalFunction",
}


@dataclass
class AttackArgs:
    """Attack arguments to be passed to :class:`~codeattack.Attacker`.
    ...
    Args:
        ...
        query_budget (:obj:`int`, `optional`, defaults to :obj:`None`):
            ...
            If not set, we use the query budget set in the :class:`~codeattack.goal_functions.GoalFunction` object (which by default is :obj:`float("inf")`).

            .. note::
                Setting this overwrites the query budget set in :class:`~codeattack.goal_functions.GoalFunction` object.
        ...
        log_to_visdom (:obj:`dict`, `optional`, defaults to :obj:`None`):
            If set, Visdom logger is used with the provided dictionary passed as a keyword arguments to :class:`~codeattack.loggers.VisdomLogger`.
        ...
        log_to_wandb(:obj:`dict`, `optional`, defaults to :obj:`None`):
            If set, WandB logger is used with the provided dictionary passed as a keyword arguments to :class:`~codeattack.loggers.WeightsAndBiasesLogger`.
            Pass in empty dictionary to use default arguments. For custom logger, the dictionary should have the following
    ...
    random_seed: int = 765  # equivalent to sum((ord(c) for c in "codeattack"))
    parallel: bool = False
    ...
    def create_loggers_from_args(cls, args):
        ...
        # Create logger
        attack_log_manager = codeattack.loggers.AttackLogManager()
...
class _CommandLineAttackArgs:
    ...
    def _create_attack_from_args(cls, args, model_wrapper):
        ...
        if args.attack_recipe:
            if args.attack_recipe in ATTACK_RECIPE_NAMES:
                recipe = eval(
