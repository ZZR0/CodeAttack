...
from codeattack.goal_function_results.goal_function_result import (
    GoalFunctionResultStatus,
)
from codeattack.shared import validators
...
class GoalFunction(ABC):
    ...
    def _call_model_uncached(self, attacked_text_list):
        """Queries model and returns outputs for a list of AttackedCode
        objects."""
    ...
    def _call_model(self, attacked_text_list):
        """Gets predictions for a list of ``AttackedCode`` objects.
